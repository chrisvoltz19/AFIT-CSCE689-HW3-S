...
void PCalc_T::markNonPrimes()
{
   ...
   // Do the selection part of the algorithm
   ...
   // put 1 in primes so threads know they are done once they complete what they have
...
void PCalc_T::cleanup() {
   ...
   std::cout << "Threads Cleaned Up " << std::endl;
...
void PCalc_T::createPool(int num) 
{
   ...
   for(int i = 0; i < num; i++)
   {
	// use a lambda to pass in this and run the tRun function with parameter index
	tPool.emplace_back(std::thread([this, i]{tRun(i);}));
   }
}
